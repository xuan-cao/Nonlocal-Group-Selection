SSS = function(X,y,ind_fun, #g.size,
               delta, 
               r, alpha_1, alpha_2, N, C0=1,verbose=TRUE){
  n = nrow(X)
  #p = ncol(X)
  #p = ncol(X)/g.size
  ...
  #print(X[,ind2])
  #print(y)
  curr = ind_fun(X, ind2, y, n, alpha_1, alpha_2, r, tau, cal=TRUE)   # evaluate the objective value on the initial model
  ...
  for(i in 1:(p-p.g)){
    ...
    int  = ind_fun(X, ind.p, y, n, alpha_1, alpha_2, r, tau, cal=TRUE) 
    obj.p =  c(int)
  ...
  for(i in 1:p.g){
    ...
    int  = ind_fun(X, ind.m, y, n, alpha_1, alpha_2, r, tau, cal=TRUE) 
    obj.m =  c(int)
  ...
  for(i in 1:p.g){
    for(w in 1:(p-p.g)){
      ...
      int  = ind_fun(X, ind.s, y, n, alpha_1, alpha_2, r, tau, cal=TRUE) 
      obj.s =  c(int)
  ...
  for(uu in 1:C0){ # repeat the SSS algorithm C0 times  
    ...
    for(iter in 1:N){ 
      ...
      print("#################################")
      curr = ind_fun(X, ind2, y, n, alpha_1, alpha_2, r, tau, cal=TRUE)   # print the objective value of the current model
      print("# of iterations");print(iter);
      print("The Selected Variables in the Searched MAP Model");print(ind2.pr);
      print("The Evaluated Object Value at the Searched MAP Model");print(obj.pr);
      ...
      #   print("#################################")
      #   curr = ind_fun(X, ind2, y, n, alpha_1, alpha_2, r, tau)   # print the objective value of the current model
      #   print("# of iterations");print(iter);
      #   print("The Selected Variables in the Searched MAP Model");print(ind2.pr);
      #   print("The Evaluated Object Value at the Searched MAP Model");print(obj.pr);
      #   print("Current Model");print(ind2);
